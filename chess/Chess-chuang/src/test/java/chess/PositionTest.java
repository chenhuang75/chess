...
public class PositionTest {
    ...
    @Test
    public void testPositionValidility() {
        assertEquals(false, new Position('a', 9).isvalid());
        assertEquals(false, new Position('a', 0).isvalid());
        assertEquals(false, new Position('i', 1).isvalid());
    }
}
